...
To build the final jar and optimize the RslManager application for production, run:
...
Then navigate to [http://localhost:9051](http://localhost:9051) in your browser.
